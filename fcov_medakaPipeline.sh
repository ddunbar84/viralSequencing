...
mkdir /home3/dd87a/"$project"/allFast5;
...
# /software/ont-guppy-GPU-v4.5.3/bin/guppy_basecaller --input_path /home3/dd87a/fcov_28sept23/allFast5 --save_path /home3/dd87a/fcov_28sept23/basecalled --flowcell FLO-FLG001 --kit SQK-PCB109 -x "cuda:0"

# guppy_barcoder -r --input_path /home3/dd87a/fcov_28sept23/basecalled/pass --save_path /home3/dd87a/fcov_28sept23/demulti_trim --trim_barcodes 

wget --no-check-certificate -c "https://onedrive.live.com/embed?resid=E0BEB5FAC74F4A74%2110930&authkey=!AC9aDb_98UWM2os" -O fcov_03oct23_allFast5.zip

<iframe src="https://onedrive.live.com/embed?resid=E0BEB5FAC74F4A74%2110930&authkey=!AC9aDb_98UWM2os" width="98" height="120" frameborder="0" scrolling="no"></iframe>
...
##### BASECALL RNA ON GPU
# /software/ont-guppy-GPU-v4.5.3/bin/guppy_basecaller --input_path /home3/dd87a/"$project"/allFast5 --save_path /home3/dd87a/"$project"/basecalled --flowcell FLO-MIN106 --kit SQK-PCB109 -x "cuda:0"
/software/ont-guppy-GPU-v4.5.3/bin/guppy_basecaller --input_path /home3/dd87a/fcov_03oct23/allFast5 --save_path /home3/dd87a/fcov_03oct23/basecalled --flowcell FLO-FLG001 --kit SQK-PCB109 -x "cuda:0"
...
guppy_barcoder -r --input_path /home3/dd87a/fcov_03oct23/basecalled/pass --save_path /home3/dd87a/fcov_03oct23/demulti_trim --trim_barcodes 
