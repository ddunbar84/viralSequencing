...
# Map reads to ref and move mapped reads to file
    ...
    minimap2 -ax map-ont "$refseq" /home3/dd87a/"$project"/demulti_trim/barcode01/barcode01Filt.fastq | /software/samtools-v1.16.1/bin/samtools view -b -F 4 > /home3/dd87a/"$project"/demulti_trim/barcode01/barcode01_mapped.sam

# Map reads to ref and move unmapped reads to file
    
    minimap2 -ax map-ont "$refseq" /home3/dd87a/"$project"/demulti_trim/barcode01/barcode01Filt.fastq | /software/samtools-v1.16.1/bin/samtools view -b -f 4 > /home3/dd87a/"$project"/demulti_trim/barcode01/barcode01_unmapped.sam

# Convert sam file of mapped reads to fastq to be used as input for de novo assembly
    
    /software/bedtools-v2.29.1/bin/bamToFastq -i "$refseq"/demulti_trim/barcode01/barcode01_mapped.sam -fq "$refseq"/demulti_trim/barcode01/barcode01_mapped.fastq 
