...
### Draft assembly contigs : /home3/dd87a/"$project"/draftAssembly/"$sampleID"/assembly.fasta
...
do
       ...
       echo $folderName;
       echo $sampleID;
	   #racon -m 8 -x -6 -g -8 -w 500 -t 8 /home3/dd87a/"$project"/demulti_trim/"$folderName"/"$folderName"Chop.fastq /home3/dd87a/"$project"/assemblies/"$folderName"draft.sam /home3/dd87a/"$project"/draftAssembly/"$sampleID"/assembly.fasta > racon.fasta
